...
Assert-True ($html -match '<link rel="icon" type="image/png" sizes="600x600" href="/assets/favicon\.png">' -and $html -match '<link rel="shortcut icon" href="/assets/favicon\.png">' -and $html -match '<link rel="apple-touch-icon" href="/assets/favicon\.png">') "Favicon links are missing from index"
Assert-True ($impressumHtml -match '<link rel="icon" type="image/png" sizes="600x600" href="/assets/favicon\.png">' -and $datenschutzHtml -match '<link rel="icon" type="image/png" sizes="600x600" href="/assets/favicon\.png">') "Favicon links are missing from legal pages"
